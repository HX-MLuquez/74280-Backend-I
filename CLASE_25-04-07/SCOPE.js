...
const vacio = null 
var yaSosUndefined
console.log(yaSosUndefined);

function saludar() {
  var saludo = "holitis";
  function saludarB() {
    var otroSaludo = "chauuuuuuu";
    console.log(otroSaludo, saludo, algo)
    return {otroSaludo,saludo,algo}
  }
  const result = saludarB()
  return result
}
const dameOtroSaludo = saludar().otroSaludo

console.log(dameOtroSaludo);

if(true){
  var aaa = 10555;
  console.log(aaa); // 10555
}
